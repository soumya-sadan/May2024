...
public class ElementUtil {
	...
	private void checkelementHighlightandFlash(WebElement element) {
	...
	public WebElement getElement(By locator) {
		...
		checkelementHighlightandFlash(element);
		return element;
	}
	...
	public void doActionsSendKeysAndEnter(By locator, String value) {
		act.sendKeys(getElement(locator), value).sendKeys(Keys.ENTER).perform();
	}
